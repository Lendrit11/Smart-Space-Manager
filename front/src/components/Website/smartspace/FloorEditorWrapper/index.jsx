...
export default function FloorEditorWrapper({ floorId }) {
  console.log("FloorEditorWrapper floorId:", floorId);
    ...
    <div className="h-full flex flex-col gap-4 min-h-0">
      <div className="flex items-center justify-between">
        ...
        <div className="text-sm text-slate-400">
          Kati i zgjedhur:
          <span className="text-white font-medium ml-1">{floorId}</span>
        </div>
      </div>

      <div className="flex-1 bg-slate-900/40 rounded-md p-4 overflow-auto min-h-0">
